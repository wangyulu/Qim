...
// cresate database kim_base default character set utf8mb4 collate utf8mb4_unicode_ci;
...
type MessageIndex struct {
	...
	AccountB  string `gorm:"size:60; not null; comment:发送消息的另一方"`
	Direction int64  `gorm:"default:0; not null; comment:1表示AccountA为发送者"`
	MessageID int64  `gorm:"not null; comment:关联消息内容表主键ID"`
